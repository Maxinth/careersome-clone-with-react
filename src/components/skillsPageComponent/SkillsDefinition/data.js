export default {
  Adaptability: {
    title: "Adaptability",
    firstText: `Adaptability means being able to adjust easily to new
    ...
    secondText: ` it’s important that you learn how to become more adaptable, as
  ...
  attentionToDetail: {
    ...
    firstText: `Attention to detail is the act of being meticulous to perform a task reasonably well.
 Attention to detail involves concentrating and making a conscious effort to avoid error
  in the work you do so as to produce a thorough and accurate work.`,
    ...
    secondText: `Attention to detail can be learned, practiced, and mastered 
just like other skills such as communicating effectively and critical`,
    ...
    infoText: "Improve Your Attention to Detail",
    referenceList: [
  ...
  communication: {
    ...
    infoText: "communicate effectively",
    referenceList: [
  ...
  multitasking: {
    title: "Multitasking?",
    firstText: `Multitasking is the act of doing more than one thing at the same time. 
                Multitasking is applied in most cases to get more work done in less time,
                but can be counter-productive if not applied properly.`,
    secondText: `To be able to multitask effectively, will help you maximize your time and performance,
